...
# This script completely removes all traces of the OpenTelemetry demo installation
...
cleanup_logs() {
    ...
    # Clear journal logs for our services
...
main() {
    log_info "Starting complete cleanup of OpenTelemetry Demo installation"
